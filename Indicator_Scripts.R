...
#Merge data#
LWSSDataA <- merge_phyloseq (BIOM,TREE,META)
...
LWSSDataA <- merge_phyloseq(ASV, TAX, dotted_meta, TREE)

#Change taxa names if needed#
colnames(tax_table(LWSSDataA))
colnames(tax_table(LWSSDataA))=c("Kingdom","Phylum","Class","Order","Family","Genus", "Species")
colnames(tax_table(LWSSDataA))

###Create at more filtered set of LWSS Data###
ntaxa(LWSSDataA) #166944#
FLWSSDataA <- filter_taxa(LWSSDataA, function(x) sum(x) >0, TRUE)
ntaxa(FLWSSDataA) #110575#
RFLWSSDataAasv <- filter_taxa(FLWSSDataA, function(x) sum(x) >20, TRUE)
ntaxa(RFLWSSDataAasv) #9988#

#Determine the number of samples in each category and subcategory#
length(which(sample_data(RFLWSSDataAasv)$Estuary == "SLE")) #48
length(which(sample_data(RFLWSSDataAasv)$Estuary == "IRL")) #156

length(which(sample_data(RFLWSSDataAasv)$Muck == "Not")) #140
length(which(sample_data(RFLWSSDataAasv)$Muck == "Muck")) #40
length(which(sample_data(RFLWSSDataAasv)$Muck == "Mucky")) #14
length(which(sample_data(RFLWSSDataAasv)$Muck == "Muckish")) #10

length(which(sample_data(RFLWSSDataAasv)$LOI.Cu == "Low-Low")) #140
length(which(sample_data(RFLWSSDataAasv)$LOI.Cu == "High-Low")) #38
length(which(sample_data(RFLWSSDataAasv)$LOI.Cu == "High-High")) #24
length(which(sample_data(RFLWSSDataAasv)$LOI.Cu == "Low-High")) #2
...
estuary_cudds_asv = phyloseq_to_deseq2(RFLWSSDataAasv,  ~ Estuary)
...
estuary_DESeq2_sig_res_taxo_asv = cbind(as(estuary_DESeq2_sig_res_asv, "data.frame"), as(tax_table(RFLWSSDataAasv)[rownames(estuary_DESeq2_sig_res_asv), ], "matrix"))

#Make dataframe with asvs added in from all sites#
estuary_DESeq2_sig_res_taxo_seqs_asv = cbind(as(estuary_DESeq2_sig_res_taxo_asv, "data.frame"), as(otu_table(RFLWSSDataAasv)[rownames(estuary_DESeq2_sig_res_taxo_asv), ], "matrix"))
...
length(which(estuary_DESeq2_sig_res_taxo_seqs_asv$log2FoldChange > 0)) #751
#Number of IRL indicators#
length(which(estuary_DESeq2_sig_res_taxo_seqs_asv$log2FoldChange < 0)) #1381
...
RFLWSSMuckDataAasv = subset_samples(RFLWSSDataAasv, Muck=="Muck")
RFLWSSNotDataAasv = subset_samples(RFLWSSDataAasv, Muck=="Not")
RFLWSSMuckvsNotDataAasv = merge_phyloseq(RFLWSSMuckDataAasv, RFLWSSNotDataAasv)

##Run DESEQ2 and make a txt table of results##
#Convert phyloseq to deseq2 object centered around a muck factor#
muck_cudds_asv = phyloseq_to_deseq2(RFLWSSMuckvsNotDataAasv,  ~ Muck)
...
#Make dataframe with taxanomy added in#
muck_DESeq2_sig_res_taxo_asv = cbind(as(muck_DESeq2_sig_res_asv, "data.frame"), as(tax_table(RFLWSSMuckvsNotDataAasv)[rownames(Rmucksigtab), ], "matrix"))

#Make dataframe with asvs added in from all sites#
muck_DESeq2_sig_res_taxo_seqs_asv = cbind(as(muck_DESeq2_sig_res_taxo_asv, "data.frame"), as(otu_table(RFLWSSDataAasv)[rownames(muck_DESeq2_sig_res_taxo_asv), ], "matrix"))
...
length(which(muck_DESeq2_sig_res_taxo_seqs_asv$log2FoldChange > 0)) #701
#Number of Muck indicators#
length(which(muck_DESeq2_sig_res_taxo_seqs_asv$log2FoldChange < 0)) #230

###RUN DESEQ2 AT asv LEVEL ON TOM/Cu EXTREME SUBCATEGORIES###

##Prepare for running DESeq2##
#Make phyloseq focusing on High-High and High-Low subcategories#  
RFLWSSHHDataAasv = subset_samples(RFLWSSDataAasv, LOI.Cu=="High-High")
RFLWSSHLDataAasv = subset_samples(RFLWSSDataAasv, LOI.Cu=="High-Low")
RFLWSSHHvsHLDataAasv = merge_phyloseq(RFLWSSHHDataAasv, RFLWSSHLDataAasv)

##Run DESEQ2 and make a txt table of results##
#Convert phyloseq to deseq2 object centered around a loicu factor#
tomcu_cudds_asv = phyloseq_to_deseq2(RFLWSSHHvsHLDataAasv,  ~ LOI.Cu)
...
#Make dataframe with taxanomy added in#
tomcu_DESeq2_sig_res_taxo_asv = cbind(as(tomcu_DESeq2_sig_res_asv, "data.frame"), as(tax_table(RFLWSSHHvsHLDataAasv)[rownames(tomcu_DESeq2_sig_res_asv), ], "matrix"))

#Make dataframe with asvs added in from all sites#
tomcu_DESeq2_sig_res_taxo_seqs_asv = cbind(as(tomcu_DESeq2_sig_res_taxo_asv, "data.frame"), as(otu_table(RFLWSSDataAasv)[rownames(tomcu_DESeq2_sig_res_taxo_asv), ], "matrix"))
...
length(which(tomcu_DESeq2_sig_res_taxo_seqs_asv$log2FoldChange > 0)) #453
#Number of High.High indicators#
length(which(tomcu_DESeq2_sig_res_taxo_seqs_asv$log2FoldChange < 0)) #342
...
#Number of Not indicators# 
length(which(filtered_muck_DESeq2_sig_res_taxo_seqs_asv$log2FoldChange > 0)) #25
#Number of Muck indicators#
length(which(filtered_muck_DESeq2_sig_res_taxo_seqs_asv$log2FoldChange < 0)) #44
#Number of High.Low indicators# 
length(which(filtered_tomcu_DESeq2_sig_res_taxo_seqs_asv$log2FoldChange > 0)) #30
#Number of High.High indicators#
length(which(filtered_tomcu_DESeq2_sig_res_taxo_seqs_asv$log2FoldChange < 0)) #128
#Number of SLE indicators# 
length(which(filtered_estuary_DESeq2_sig_res_taxo_seqs_asv$log2FoldChange > 0)) #303
#Number of IRL indicators#
length(which(filtered_estuary_DESeq2_sig_res_taxo_seqs_asv$log2FoldChange < 0)) #527
...
UFDestuaryDataAasv <- prune_taxa(charac_unfiltered_DESeq2_estuary_asvs, RFLWSSDataAasv)
...
UFDmuckDataAasv <- prune_taxa(charac_unfiltered_DESeq2_muck_asvs, RFLWSSDataAasv)
...
UFDtomcuDataAasv <- prune_taxa(charac_unfiltered_DESeq2_tomcu_asvs, RFLWSSDataAasv)
...
FDestuaryDataAasv <- prune_taxa(charac_filtered_DESeq2_estuary_asvs, RFLWSSDataAasv)
...
FDmuckDataAasv <- prune_taxa(charac_filtered_DESeq2_muck_asvs, RFLWSSDataAasv)
...
FDtomcuDataAasv <- prune_taxa(charac_filtered_DESeq2_tomcu_asvs, RFLWSSDataAasv)
...
estuary_seqs_asv = as(otu_table(RFLWSSDataAasv), "matrix")
...
estuary_meta = as(sample_data(RFLWSSDataAasv), "matrix")
...
#Take out OTU aka asv table from metadata focused phyloseq object#
muck_seqs_asv = as(otu_table(RFLWSSMuckvsNotDataAasv), "matrix")
...
#Take out metadata table metadata focused phyloseq object#
muck_meta = as(sample_data(RFLWSSMuckvsNotDataA), "matrix")
...
#Take out OTU aka asv table from metadata focused phyloseq object#
tomcu_seqs_asv = as(otu_table(RFLWSSHHvsHLDataAasv), "matrix")
...
#Take out metadata table metadata focused phyloseq object#
tomcu_meta = as(sample_data(RFLWSSHHvsHLDataA), "matrix")
...
estuary_IS_sig_res_taxo_asv = cbind(as(estuary_IS_sig_res_taxo_asv, "data.frame"), as(tax_table(RFLWSSMuckvsNotDataA)[rownames(estuary_IS_sig_res_taxo_asv), ], "matrix"))

#Make dataframe with asvs added in from all sites#
estuary_IS_sig_res_taxo_seqs_asv = cbind(as(estuary_IS_sig_res_taxo_asv, "data.frame"), as(otu_table(RFLWSSDataAasv)[rownames(estuary_IS_sig_res_taxo_asv), ], "matrix"))
...
length(which(sample_data(estuary_IS_sig_res_asv)$group == "1")) #1882 IRL
length(which(sample_data(estuary_IS_sig_res_asv)$group == "2")) #2997 SLE
...
muck_IS_sig_res_taxo_asv = cbind(as(muck_IS_sig_res_taxo_asv, "data.frame"), as(tax_table(RFLWSSMuckvsNotDataA)[rownames(muck_IS_sig_res_taxo_asv), ], "matrix"))

#Make dataframe with asvs added in from all sites#
muck_IS_sig_res_taxo_seqs_asv = cbind(as(muck_IS_sig_res_taxo_asv, "data.frame"), as(otu_table(RFLWSSDataAasv)[rownames(muck_IS_sig_res_taxo_asv), ], "matrix"))
...
#Check the number of indicators in each group after padj#
length(which(sample_data(muck_IS_sig_res_asv)$group == "1")) #2342 Muck
length(which(sample_data(muck_IS_sig_res_asv)$group == "2")) #626 Not

##Continue asv indicspecies analysis for TOM/Cu Category##

#Upload new table#
tomcu_IS_res_asv <- read.csv(file.choose())
tomcu_IS_res_asv <- LOICu_IS
#Make a new p value adjusted column#
...
tomcu_IS_sig_res_taxo_asv = cbind(as(tomcu_IS_sig_res_taxo_asv, "data.frame"), as(tax_table(RFLWSSMuckvsNotDataA)[rownames(tomcu_IS_sig_res_taxo_asv), ], "matrix"))

#Make dataframe with asvs added in from all sites#
tomcu_IS_sig_res_taxo_seqs_asv = cbind(as(tomcu_IS_sig_res_taxo_asv, "data.frame"), as(otu_table(RFLWSSDataAasv)[rownames(tomcu_IS_sig_res_taxo_asv), ], "matrix"))
...
#Check the number of indicators in each group after padj#
length(which(sample_data(tomcu_IS_sig_res_asv)$group == "1")) #1030 High/High
length(which(sample_data(tomcu_IS_sig_res_asv)$group == "2")) #666 High/Low
...
length(which(sample_data(filtered_estuary_IS_sig_res_taxo_seqs_asv)$group == "1")) #861 IRL
length(which(sample_data(filtered_estuary_IS_sig_res_taxo_seqs_asv)$group == "2")) #1559 SLE
length(which(sample_data(filtered_muck_IS_sig_res_taxo_seqs_asv)$group == "1")) #499 Muck
length(which(sample_data(filtered_muck_IS_sig_res_taxo_seqs_asv)$group == "2")) #38 Not
length(which(sample_data(filtered_tomcu_IS_sig_res_taxo_seqs_asv)$group == "1")) #195 High/High
length(which(sample_data(filtered_tomcu_IS_sig_res_taxo_seqs_asv)$group == "2")) #14 High/Low
...
UFISestuaryDataAasv <- prune_taxa(charac_unfiltered_IS_estuary_asvs, RFLWSSDataAasv)
...
UFISmuckDataAasv <- prune_taxa(charac_unfiltered_IS_muck_asvs, RFLWSSDataAasv)
...
UFIStomcuDataAasv <- prune_taxa(charac_unfiltered_IS_tomcu_asvs, RFLWSSDataAasv)
...
FISestuaryDataAasv <- prune_taxa(charac_filtered_IS_estuary_asvs, RFLWSSDataAasv)
...
FISmuckDataAasv <- prune_taxa(charac_filtered_IS_muck_asvs, RFLWSSDataAasv)
...
FIStomcuDataAasv <- prune_taxa(charac_filtered_IS_tomcu_asvs, RFLWSSDataAasv)
...
length(which(sample_data(unfiltered_estuary_combo_sig_res_taxo_seqs_asv)$group == "1")) #1209 IRL
length(which(sample_data(unfiltered_estuary_combo_sig_res_taxo_seqs_asv)$group == "2")) #742 SLE
length(which(sample_data(unfiltered_muck_combo_sig_res_taxo_seqs_asv)$group == "1")) #211 Muck
length(which(sample_data(unfiltered_muck_combo_sig_res_taxo_seqs_asv)$group == "2")) #450 Not
length(which(sample_data(unfiltered_tomcu_combo_sig_res_taxo_seqs_asv)$group == "1")) #325 High/High
length(which(sample_data(unfiltered_tomcu_combo_sig_res_taxo_seqs_asv)$group == "2")) #418 High/Low

#Determine the number of indicators in each subcategory of the filtered Combo tables#
length(which(sample_data(filtered_estuary_combo_sig_res_taxo_seqs_asv)$group == "1")) #296 IRL
length(which(sample_data(filtered_estuary_combo_sig_res_taxo_seqs_asv)$group == "2")) #120 SLE
length(which(sample_data(filtered_muck_combo_sig_res_taxo_seqs_asv)$group == "1")) #16 Muck
length(which(sample_data(filtered_muck_combo_sig_res_taxo_seqs_asv)$group == "2")) #14 Not
length(which(sample_data(filtered_tomcu_combo_sig_res_taxo_seqs_asv)$group == "1")) #14 High/High
...
UFCestuaryDataAasv <- prune_taxa(charac_unfiltered_Combo_estuary_asvs, RFLWSSDataAasv)
...
UFCmuckDataAasv <- prune_taxa(charac_unfiltered_Combo_muck_asvs, RFLWSSDataAasv)
...
UFCtomcuDataAasv <- prune_taxa(charac_unfiltered_Combo_tomcu_asvs, RFLWSSDataAasv)
...
FCestuaryDataAasv <- prune_taxa(charac_filtered_Combo_estuary_asvs, RFLWSSDataAasv)
...
FCmuckDataAasv <- prune_taxa(charac_filtered_Combo_muck_asvs, RFLWSSDataAasv)
...
FCtomcuDataAasv <- prune_taxa(charac_filtered_Combo_tomcu_asvs, RFLWSSDataAasv)
...
nsamples(RFLWSSDataAasv) #204
RFLWSSDataAasv = prune_samples(sample_sums(RFLWSSDataAasv)>=1, RFLWSSDataAasv)
nsamples(RFLWSSDataAasv) #204

#Make a matrix with the sample_data and relabel subcategories to make metadata-defined column#
Original_Est_Muck_asv <- as.matrix(sample_data(RFLWSSDataAasv))
...
bc <- vegdist(t(otu_table(RFLWSSDataAasv)))
...
#Test for Estuary Effeciency# 0.9852941
...
#Test for IRL Effeciency aka Specificity# 0.9807692
...
TotalPCoA <- ordinate(RFLWSSDataAasv,"PCoA")
p = plot_ordination(RFLWSSDataAasv, TotalPCoA, color="Estuary") + 
...
#Test for 0MC Effeciency aka Specificity# 0.8357143
...
TotalPCoA <- ordinate(RFLWSSDataAasv,"PCoA")
p = plot_ordination(RFLWSSDataAasv, TotalPCoA, color="Muck") + 
...
#Remove any samples with no asvs from target phyloseq#
nsamples(RFLWSSHHvsHLDataAasv) #62
RFLWSSHHvsHLDataAasv = prune_samples(sample_sums(RFLWSSHHvsHLDataAasv)>=1, RFLWSSHHvsHLDataAasv)
nsamples(RFLWSSHHvsHLDataAasv) #62

#Make a matrix with the sample_data and relabel subcategories to make metadata-defined column#
Original_TOMCu_asv <- as.matrix(sample_data(RFLWSSHHvsHLDataAasv))
...
#Create Bray-Curtis distance matrix from asv table#
bc <- vegdist(t(otu_table(RFLWSSHHvsHLDataAasv)))
...
#Determine Total TOM/Cu Efficiency# 0.6129032
sum(Original_TOMCu_asv$LOI.Cu == Original_TOMCu_asv$Orginal_asv)/nrow(Original_TOMCu_asv)

#Determine HiHi Efficiency  aka Sensitivity# 0.5416667
...
TotalPCoA <- ordinate(RFLWSSHHvsHLDataAasv,"PCoA")
p = plot_ordination(RFLWSSHHvsHLDataAasv, TotalPCoA, color="LOI.Cu") + 
...
#Remove any samples with no asvs from target phyloseq#
nsamples(UFISestuaryDataAasv) #204
...
#Remove any samples with no asvs from target phyloseq#
nsamples(FISestuaryDataAasv) #204
...
#Test Total Estuary Efficiency# 0.9558824
...
#Remove any samples with no asvs from target phyloseq#
nsamples(UFDestuaryDataAasv) #204
...
#Remove any samples with no asvs from target phyloseq#
nsamples(FDestuaryDataAasv) #204
...
#Test Total Estuary Efficiency# 0.9460784
...
#Remove any samples with no asvs from target phyloseq#
nsamples(UFCestuaryDataAasv) #204
...
#Remove any samples with no asvs from target phyloseq#
nsamples(FCestuaryDataAasv) #204
...
#Test Total Estuary Efficiency# 0.9656863
...
#Remove any samples with no asvs from target phyloseq#
nsamples(FCmuckDataAasv) #204
FCmuckDataAasv = prune_samples(sample_sums(FCmuckDataAasv)>=1, FCmuckDataAasv)
nsamples(FCmuckDataAasv) #192

#Make a matrix with the sample_data and relabel subcategories to make metadata-defined column#
F_C_Muck_asvs <- as.matrix(sample_data(FCmuckDataAasv))
F_C_Muck_asvs[F_C_Muck_asvs ==  "Muck"] <- 1
F_C_Muck_asvs[F_C_Muck_asvs ==  "Not"] <- 2
F_C_Muck_asvs[F_C_Muck_asvs ==  "Mucky"] <- 1
F_C_Muck_asvs[F_C_Muck_asvs ==  "Muckish"] <- 1
...
#Remove any samples with no asvs from target phyloseq#
nsamples(UFISfoctomcuDataAasv) #62
...
#Test Total TOM/Cu Efficiency# 0.7903226
...
#Test High-Low Indicators aka Specificity# 0.6578947
...
#Test Total TOM/Cu Efficiency# 0.6666667
...
#Test HiLo Efficiency aka Sensitivity# 0.4444444
...
#Remove any samples with no asvs from target phyloseq#
nsamples(UFDfoctomcuDataAasv) #62
...
#Test HiLo Efficiency aka Specificity# 0.6578947
...
#Test Total TOM/Cu Efficiency# 0.9180328
sum(F_D_TOMCu_asv$LOI.Cu == F_D_TOMCu_asv$MP_FDTOMCuasv)/nrow(F_D_TOMCu_asv)

#Test HiHi Efficiency aka Sensitivity# 0.7916667
...
#Remove any samples with no asvs from target phyloseq#
nsamples(UFCfoctomcuDataAasv) #62
...
#Test Total TOM/Cu Efficiency# 0.8888889
sum(F_C_TOMCu_asv$LOI.Cu == F_C_TOMCu_asv$MP_FCTOMCuasv)/nrow(F_C_TOMCu_asv)

#Test HiHi Efficiency aka Sensitivity# 0.8695652
...
ggplot(Product_Tested_Adjusted_Summary, aes(x=Taxonomic_Level, y=Percentage, color=Taxonomic_Level)) + 
  ...
  scale_x_discrete(limits=c("ASV", "Species", "Genus", "Family"), labels=c("ASV", "Species", "Genus", "Family"))
...
ggplot(Product_Tested_Adjusted_Summary, aes(x=Filtering_Status, y=Percentage, color=Filtering_Status)) + 
  geom_boxplot()+ 
  ylab("Product (%)") +
  scale_color_discrete(name="Filtering Status")+
...
LWSS_Meta_V2 <- as(sample_data(RLWSSgenusA), "data.frame")
...
LWSS_Meta_V2$UF_Combo_Genus_IRL <- prune_taxa(as.character(unfiltered_estuary_combo_sig_res_taxo_seqs_genus$ESV.ID[unfiltered_estuary_combo_sig_res_taxo_seqs_genus$log2FoldChange<0]), RLWSSgenusA) %>% sample_sums() 

#Determine the sequence sums from Unfiltered, Combo, Genus Level SLE indicators and upload as a new column#
LWSS_Meta_V2$UF_Combo_Genus_SLE <- prune_taxa(as.character(unfiltered_estuary_combo_sig_res_taxo_seqs_genus$ESV.ID[unfiltered_estuary_combo_sig_res_taxo_seqs_genus$log2FoldChange>0]), RLWSSgenusA) %>% sample_sums() 
...
LWSS_Meta_V2$UF_Combo_Genus_3MC <- prune_taxa(as.character(unfiltered_muck_combo_sig_res_taxo_seqs_genus$ESV.ID[unfiltered_muck_combo_sig_res_taxo_seqs_genus$log2FoldChange<0]), RLWSSgenusA) %>% sample_sums() 

#Determine the sequence sums from Unfiltered, Combo, Genus Level 0MC indicators and upload as a new column#
LWSS_Meta_V2$UF_Combo_Genus_0MC <- prune_taxa(as.character(unfiltered_muck_combo_sig_res_taxo_seqs_genus$ESV.ID[unfiltered_muck_combo_sig_res_taxo_seqs_genus$log2FoldChange>0]), RLWSSgenusA) %>% sample_sums() 
...
LWSS_Meta_V2$UF_Combo_Genus_HiHi <- prune_taxa(as.character(unfiltered_tomcu_combo_sig_res_taxo_seqs_genus$ESV.ID[unfiltered_tomcu_combo_sig_res_taxo_seqs_genus$log2FoldChange<0]), RLWSSgenusA) %>% sample_sums() 

#Determine the sequence sums from Unfiltered, Combo, Genus Level HiLo indicators and upload as a new column#
LWSS_Meta_V2$UF_Combo_Genus_HiLo <- prune_taxa(as.character(unfiltered_tomcu_combo_sig_res_taxo_seqs_genus$ESV.ID[unfiltered_tomcu_combo_sig_res_taxo_seqs_genus$log2FoldChange>0]), RLWSSgenusA) %>% sample_sums() 
...
LWSS_Env <- read.csv(file.choose())

#Make the row names the Sample IDs
LWSS_Env <- LWSS_Env %>% remove_rownames %>% column_to_rownames(var="Site")

#Combine the metadata and environmental data tables#
LWSS_Total_V2 <- merge(LWSS_Env, LWSS_Meta_V2, by="row.names")
...
ggplot(data = subset(LWSS_Total_V2, Loss.On.Ignition.aka.Total.Organic.Matter > 10), aes( x = Site, y = UF_Combo_Genus_TOMCu, color=LOI.Cu)) +
  geom_boxplot()+
  ylab("Affected Indicator Percentage") +
  xlab("Site") +
  theme(axis.text.x  = element_text(angle=45, hjust=1))+
